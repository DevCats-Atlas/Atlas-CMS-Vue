...
// Initialize from current state (theme was already applied by script in head)
const isDarkMode = ref(document.documentElement.classList.contains('dark'));

const initTheme = () => {
    // Sync with current state (theme was already applied by script in head)
                        ...
                        <div class="space-y-2 rounded-lg bg-gray-50/50 dark:bg-gray-900/30 p-2 -mx-2">
                            ...
                            <div class="space-y-1">
                                <Link
                                    ...
                                    :class="{ 'nav-sidebar-link-active': isActive(item) }"
                                >
                ...
                <div class="flex items-center justify-between h-16 px-6">
                    <div class="flex items-center space-x-4">
                        ...
                        <Link
                            href="/admin"
                            class="nav-tab"
                            :class="{ 'nav-tab-active': isAdminSection }"
                        >
                            {{ t('admin.layout.cms') }}
                        </Link>
                        <Link
                            ...
                            href="/admin/system"
                            class="nav-tab"
                            :class="{ 'nav-tab-active': isSystemSection }"
                        >
