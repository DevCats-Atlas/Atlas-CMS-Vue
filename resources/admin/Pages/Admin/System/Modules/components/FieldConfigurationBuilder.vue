...
// Check table columns - works with or without moduleId
const checkTableWithFetch = async () => {
    ...
    try {
        ...
        // If moduleId is provided, use the module endpoint
        // Otherwise, use the generic endpoint for relationship tables
        const url = props.moduleId 
            ? `/admin/system/modules/${props.moduleId}/check-table-columns`
            : `/admin/system/modules/check-table-columns`;
                    ...
                    >
                        <div class="flex items-center justify-between gap-2">
                            ...
                            <div class="flex items-center gap-4">
                                <label v-if="showShowInList" class="inline-flex items-center gap-2 text-xs text-gray-700 dark:text-gray-300">
                                    <input
                                        type="checkbox"
                                ...
                                <label v-if="showEditable" class="inline-flex items-center gap-2 text-xs text-gray-700 dark:text-gray-300">
                                    <input
                                        type="checkbox"
